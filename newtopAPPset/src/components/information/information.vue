...
export default {
  ...
  data() {
    return {
      ...
      carData: [
        {name: "万东升",id: "01",positon: "总经理",unread:1,headPortrait: require("../../assets/imges/logo/newtop2.png"),
          chatInfo: [
            {news: "周一开财务通报会",newsId: 1,time: "2018/10/30 10:11:11"},
            { news: "周一开常务会议", newsId: 2, time: "2018/10/30 10:01:22" }
          ]
        },
        {name: "万光明",id: "01",positon: "后端大神",unread:3,headPortrait:  require("../../assets/imges/logo/newtop2.png"),
          chatInfo: [
            {news: "周一开财务通报会",newsId: 1,time: "2018/10/30 10:11:11"},
            { news: "给你一张无BUG符", newsId: 2, time: "2018/10/30 10:58:12" }
          ]
        },
        {name: "包文德",id: "01",positon: "神一样的",unread:3,headPortrait:  require("../../assets/imges/logo/newtop2.png"),
          chatInfo: [
            {news: "周一开财务通报会",newsId: 1,time: "2018/10/30 10:11:11"},
            { news: "你说啥？你再说一遍", newsId: 2, time: "2018/10/30 12:19:12" }
          ]
        },
        {name: "李海敏",id: "01",positon: "全能高手",unread:10,headPortrait:  require("../../assets/imges/logo/newtop2.png"),
          chatInfo: [
            {news: "周一开财务通报会",newsId: 1,time: "2018/10/30 10:11:11"},
            { news: "1T的文案页面一天可以P完", newsId: 2, time: "2018/10/30 16:21:12" }
          ]
        },
        {name: "张人事",id: "01",positon: "搞事情",unread:2,headPortrait:  require("../../assets/imges/logo/newtop2.png"),
          chatInfo: [
            {news: "周一开财务通报会",newsId: 1,time: "2018/10/30 10:11:11"},
            { news: "搞事情？你在给我说一次？", newsId: 2, time: "2018/10/30 19:21:12" }
          ]
        },
        {name: "龙财务",id: "01",positon: "财务总监",unread:1,headPortrait:  require("../../assets/imges/logo/newtop2.png"),
          chatInfo: [
            {news: "周一开财务通报会",newsId: 1,time: "2018/10/30 10:11:11"},
            { news: "周一开财务通报会", newsId: 2, time: "2018/10/29 10:15:12" }
          ]
        },
        {name: "集团AI智能助手",id: "01",positon: "前方高能",unread:31,headPortrait:  require("../../assets/imges/logo/newtop2.png"),
          chatInfo: [
            {news: "周一开财务通报会",newsId: 1,time: "2018/10/30 10:11:11"},
